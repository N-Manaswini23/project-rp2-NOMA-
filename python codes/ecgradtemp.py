...
Original file is located at
    https://colab.research.google.com/drive/1suWSaU9tu5OjXEgZ2943n4nfcqx1ZDuW
"""
...
plt.semilogy(y,Cuv11,color='red',marker='o',linestyle='-',label='Cuv1 grad.temp=0.05C/cm')
plt.semilogy(y,Cuv21,color='blue',marker='o',linestyle='-',label='Cuv2 grad.temp=0.05C/cm')
plt.semilogy(y,Cuv12,color='g',marker='o',linestyle='-',label='Cuv1 grad.temp=0.15C/cm')
plt.semilogy(y,Cuv22,color='purple',marker='o',linestyle='-',label='Cuv2 grad.temp=0.15C/cm')
plt.semilogy(y,Cuv1,color='black',marker='o',linestyle='-',label='Cuv(sum) grad.temp=0.05C/cm')
plt.semilogy(y,Cuv2,color='magenta',marker='o',linestyle='-',label='Cuv(sum) grad.temp=0.15C/cm')


plt.xlabel("snr (in db)");
plt.ylabel("avg ergodic capacity")
plt.grid()
plt.title("avg ergodic capacity at different gradient temperature(BL=2.4L/min)")
plt.legend()
plt.show()