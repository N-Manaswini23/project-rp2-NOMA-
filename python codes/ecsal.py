...
Original file is located at
    https://colab.research.google.com/drive/1_W4uMXdxMmfaLuvez_OrYz608lJD81pN
"""
...
plt.semilogy(y,Cuv11,color='red',marker='o',linestyle='-',label='Cuv1 salty water')
plt.semilogy(y,Cuv21,color='blue',marker='o',linestyle='-',label='Cuv2 salty water')
plt.semilogy(y,Cuv12,color='g',marker='o',linestyle='-',label='Cuv1 fresh water')
plt.semilogy(y,Cuv22,color='purple',marker='o',linestyle='-',label='Cuv2 fresh water')
plt.semilogy(y,Cuv1,color='black',marker='o',linestyle='-',label='Cuv(sum) salty water')
plt.semilogy(y,Cuv2,color='magenta',marker='o',linestyle='-',label='Cuv(sum) fresh water')


plt.xlabel("snr (in db)");
plt.ylabel("avg ergodic capacity")
plt.grid()
plt.title("avg ergodic capacity at different salinity(BL=7.1L/min)")
plt.legend()
plt.show()