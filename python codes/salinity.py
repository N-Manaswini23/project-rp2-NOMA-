...
Original file is located at
    https://colab.research.google.com/drive/11-yorQ4QvgQRSuC_p-c54dmjLcYX_-Fe
"""
...
plt.semilogy(y,Puv1,color='r',marker='o',linestyle='-',label='Puv1 salty water')
plt.semilogy(y,Puv2,color='b',marker='o',linestyle='-',label='Puv2 salty water')
plt.semilogy(y,Puv12,color='g',marker='o',linestyle='-',label='Puv1 fresh water')
plt.semilogy(y,Puv22,color='purple',marker='o',linestyle='-',label='Puv2 fresh water')
plt.xlabel("snr (in db)");
plt.ylabel("avg BER")
plt.grid()
plt.title("avg ber at different salinity levels(BL=4.7L/min)")
plt.legend()
plt.show()